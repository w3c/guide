...
The traditional criterion the Team and Advisory Committee use to evaluate whether to start a working group or advance a specification is an assessment of whether the proposed work is likely to contribute to fulfilling the W3C mission to [lead the web to its full potential](https://www.w3.org/mission/). While this is "aspirational", it requires judgement that balances the future potential of the Web against the need for real developers to make the Web work in practice. This document seeks to make the factors that go into this judgement more explicit and more generally applicable.
